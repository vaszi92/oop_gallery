...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if($new_comment && $new_comment->save()) {
                    ...
                    $from = "Gallery CMS <vaszi92@gmail.com>";

                    $mailsender->to = "me@laszlovaszi.com";
                    $mailsender->subject = "New comment at ".  strftime("%T", time());
                    $mailsender->message = "{$author} commented on {$photo->filename} at ".  strftime("%T", time()).":  \"{$body}\"";
                    $mailsender->headers = "From: {$from}";
